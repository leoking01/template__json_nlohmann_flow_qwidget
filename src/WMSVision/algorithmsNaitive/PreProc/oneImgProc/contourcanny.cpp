#include "contourcanny.h"
// const    std::string  ContourCanny::name   = "ContourCanny";
//ContourCanny::ContourCanny(MODE_CV_HCON_TYPE   mode_t ):EnkAlgorithmBase(mode_t )
//{
//mode_cv_or_hcon = mode_t ;
//class_name = "ContourCanny";
//}
#if   0     //  #endif     #if   0
ContourCanny(MODE_CV_HCON_TYPE   mode_t ) ;
...
virtual double  exportData_hcon()    {
   data_out_hcon.Image.WriteImage("png" ,255, (this->name+"."+ std::to_string(mode_cv_or_hcon)+ ".out.png").c_str()) ;return  0 ; }
#endif   //  #if   0
