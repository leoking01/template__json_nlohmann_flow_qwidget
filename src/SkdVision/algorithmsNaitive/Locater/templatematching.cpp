...
// const   std::string  TemplateMatching::name   = "TemplateMatching";
//TemplateMatching::TemplateMatching(MODE_CV_HCON_TYPE   mode_t ):EnkAlgorithmBase(mode_t )
//{
//mode_cv_or_hcon = mode_t ;
//class_name = "TemplateMatching";
//}
#if   0     //  #endif
    TemplateMatching(MODE_CV_HCON_TYPE   mode_t ) ;

    static const  std::string  name  ;//= "TemplateMatching";
