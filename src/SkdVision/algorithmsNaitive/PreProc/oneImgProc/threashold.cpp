...
//const  std::string Threashold::  name   = "Threashold";
//Threashold::Threashold(MODE_CV_HCON_TYPE   mode_t ):EnkAlgorithmBase(mode_t )
//{
//mode_cv_or_hcon = mode_t ;
//class_name = "Threashold";
//}
#if   0     //  #endif     #if   0
Threashold(MODE_CV_HCON_TYPE   mode_t ) ;
